...
var MonacoEditor = function (_Component) {
  ...
  function MonacoEditor(props) {
    ...
    _this.initMonaco = function (_ref) {
      ...
      _this._editor = monaco.editor.create(_this._node, editorOptions);
    };

    _this.initMonaco(props);
    return _this;
  }
